            ...
            def process_company_with_progress(self, company_data, index, total):
                ...
                if classification in ['no_salesforce_match', 'salesforce_qualified']:
                    ...
                    try:
                        ...
                        log_entry['ai_scoring']['result'] = 'SUCCESS'
                        log_entry['ai_scoring']['score'] = score
                        log_entry['ai_scoring']['category'] = category
                        ...
                        log_entry['ai_scoring']['result'] = 'FAILED'
                        log_entry['ai_scoring']['error'] = str(e)
