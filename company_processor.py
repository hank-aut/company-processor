...
class SalesforceClassifier:
    ...
    def search_by_company(self, company: str) -> Optional[Dict]:
        ...
        try:
            ...
            variation_escaped = normalized_input.replace("'", "\\'")
            ...
            print(f"    Salesforce: Searching for '{normalized_input}'...")
            result = self.sf.query(soql_query)
            ...
            if result.get('records'):
                ...
                # Only accept matches with score >= 0.7 (70% similarity)
                if best_score >= 0.7:
                    print(f"    Salesforce: ✅ Accepted match '{best_match.get('Name')}' with score {best_score:.2f}")
                    return {
                        'type': 'Account',
                        'id': best_match['Id'],
                    ...
                    print(f"    Salesforce: ❌ Best match score {best_score:.2f} below threshold (0.7)")
    ...
    def calculate_similarity(self, str1: str, str2: str) -> float:
        ...
        generic_words = {
            ...
            'data', 'center', 'centers', 'datacenter', 'datacenters',
        ...
        words1 = {w for w in words1 if w not in generic_words}
        words2 = {w for w in words2 if w not in generic_words}
